...
import { Mail, Instagram, Lightbulb, Bug } from "lucide-react"
...
export function Footer() {
    ...
    const [feedbackInitialType, setFeedbackInitialType] = useState<"IDEA" | "BUG">("IDEA")

    if (pathname === "/chatbot") return null

    const handleOpenFeedback = (type: "IDEA" | "BUG") => {
            ...
            <footer className="relative bg-black/20 backdrop-blur-sm border-t border-white/5 py-16 overflow-hidden">
                <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                        ...
                        {/* Support Links with Native Feedback Modal */}
                        <div className="space-y-6">
                            <h4 className="text-xs font-bold text-gray-200 uppercase tracking-widest">지원 및 피드백</h4>
                            <ul className="space-y-3">
                                ...
                                <li>
                                    <button 
                                        ...
                                        className="text-sm font-medium text-gray-400 hover:text-amber-400 transition-colors flex items-center gap-1.5"
                                    >
                                ...
                                <li>
                                    <button 
                                        ...
                                        className="text-sm font-medium text-gray-400 hover:text-red-400 transition-colors flex items-center gap-1.5"
                                    >
