                ...
                >
                    <section className="space-y-4">
                        ...
                        <p className="text-zinc-400 leading-relaxed text-sm">
                            WITHUS는 교목실의 학생 상담 및 영성 지도를 지원하기 위해 설립되었습니다. 수집된 모든 정보(성명, 닉네임, 이메일, 학년, 채팅 로그 등)는 학생들의 필요를 파악하고, 보다 나은 영적 지원을 제공하며, 학교 건학 이념에 부합하는 안전한 공동체 환경을 조성하는 데에만 사용됩니다.
                        </p>
                    </section>
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="text-zinc-400 leading-relaxed text-sm">
                            귀하는 언제든지 본인의 개인정보 열람, 정정, 삭제를 요청할 수 있습니다. 관련 문의는 교목실을 통해 진행하실 수 있습니다.
                        </p>
                    </section>
                </motion.div>
            </div>
