        ...
        <div className="min-h-screen py-32 px-6">
            <div className="max-w-4xl mx-auto space-y-12">
                ...
                <div className="space-y-6">
                    ...
                    <p className="text-gray-400 font-medium">최종 수정일: 2026년 2월 12일</p>
                </div>
                ...
                >
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="text-zinc-400 leading-relaxed text-sm">
                            본 서비스는 기독교 정신에 기초한 상호 존중과 사랑의 공동체를 지향합니다. 타인을 비방하거나 부적절한 언어를 사용하는 행위, 건학 이념에 반하는 내용을 유포하는 행위는 엄격히 금지되며 서비스 이용이 제한될 수 있습니다.
                        </p>
                    </section>
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="text-zinc-400 leading-relaxed text-sm">
                            WITHUS AI는 학생들의 영적 고민과 일상적인 질문에 도움을 주기 위한 도구입니다. 과제 대행 등 학업 정직성을 해치는 용도로 사용하는 것을 금하며, 모든 답변은 참고용으로 활용하시기 바랍니다. AI가 생성한 콘텐츠의 정확성을 보장하지 않습니다.
                        </p>
                    </section>
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="text-zinc-400 leading-relaxed text-sm">
                            우리는 언제든지 본 약관을 수정하거나 교체할 권리를 보유합니다. 변경된 약관이 게시된 후에도 서비스를 계속 이용하는 것은 새로운 약관에 동의하는 것으로 간주됩니다.
                        </p>
                    </section>
                </motion.div>
            </div>
